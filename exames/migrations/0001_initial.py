    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tipo', models.CharField(choices=[('I', 'Exame de imagem'), ('E', 'Exame de Sangue')], max_length=2)),
        ...
        migrations.CreateModel(
            name='SolicitacaoEsxames',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('status', models.CharField(choices=[('F', 'Finalizado'), ('E', 'Em análise')], max_length=2)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('exames', models.ManyToManyField(to='exames.solicitacaoesxames')),
                ('usuario', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
